        ...
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            {!showOTPInput ? (
              ...
              <>
                <div className="bg-primary-50 border border-primary-200 text-primary-800 p-3 rounded-md text-sm mb-4">
                  A verification code has been printed to the server console. Please enter it below.
                </div>
